...
* [ChemPy](https://github.com/bjodah/chempy) ⭐ 655 | 🐛 35 | 🌐 Python | 📅 2026-08-18 - A Python package useful for chemistry (mainly physical/inorganic/analytical chemistry)
...
* [Indigo](https://github.com/epam/Indigo) ⭐ 404 | 🐛 750 | 🌐 C++ | 📅 2026-08-21 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,950 | 🐛 1,163 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,435 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - Directed message passing neural networks for property prediction of molecules and reactions with uncertainty and interpretation.
...
* [webchem](https://github.com/ropensci/webchem) ⭐ 186 | 🐛 62 | 🌐 R | 📅 2026-08-21 - Chemical Information from the Web.
...
* [cclib](https://github.com/cclib/cclib) ⭐ 422 | 🐛 188 | 🌐 Python | 📅 2026-08-20 - Parsers and algorithms for computational chemistry logfiles.
