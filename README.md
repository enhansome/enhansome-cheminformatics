...
* [Indigo](https://github.com/epam/Indigo) ⭐ 405 | 🐛 750 | 🌐 C++ | 📅 2026-08-21 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,950 | 🐛 1,164 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
...
* [cclib](https://github.com/cclib/cclib) ⭐ 422 | 🐛 189 | 🌐 Python | 📅 2026-08-20 - Parsers and algorithms for computational chemistry logfiles.
...
* [OPSIN](https://github.com/dan2097/opsin) ⭐ 231 | 🐛 110 | 🌐 Java | 📅 2026-08-19 - Open Parser for Systematic IUPAC nomenclature
...
* [TeachOpenCADD](https://github.com/volkamerlab/TeachOpenCADD) ⭐ 1,051 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-07-23 - A teaching platform for computer-aided drug design (CADD) using open source packages and data.
