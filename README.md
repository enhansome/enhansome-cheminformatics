...
* [Indigo](https://github.com/epam/Indigo) ⭐ 406 | 🐛 759 | 🌐 C++ | 📅 2026-09-23 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [ChEMBL\_Structure\_Pipeline (formerly standardiser)](https://github.com/chembl/ChEMBL_Structure_Pipeline) ⭐ 250 | 🐛 9 | 🌐 Python | 📅 2025-11-24 - Tool designed to provide a simple way of standardising molecules as a prelude to e.g. molecular modelling exercises.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 7,012 | 🐛 1,186 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
...
* [DOCKSTRING](https://github.com/dockstring/dockstring) ⭐ 191 | 🐛 8 | 🌐 Python | 📅 2026-05-24 - Automates and standardizes ligand preparation for AutoDock Vina.
...
* [MDTraj](https://github.com/mdtraj/mdtraj) ⭐ 736 | 🐛 93 | 🌐 Python | 📅 2026-09-18 - Analysis of molecular dynamics trajectories.
* [ProDy](https://github.com/prody/ProDy) ⭐ 558 | 🐛 37 | 🌐 Python | 📅 2026-09-22 - A Python package for protein dynamics analysis
* [cclib](https://github.com/cclib/cclib) ⭐ 428 | 🐛 196 | 🌐 Python | 📅 2026-09-20 - Parsers and algorithms for computational chemistry logfiles.
