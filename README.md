...
* [ChemPy](https://github.com/bjodah/chempy) ⭐ 658 | 🐛 35 | 🌐 Python | 📅 2026-09-05 - A Python package useful for chemistry (mainly physical/inorganic/analytical chemistry)
* [datamol](https://github.com/datamol-org/datamol) ⭐ 551 | 🐛 3 | 🌐 Python | 📅 2026-09-09: - Molecular Manipulation Made Easy. A light wrapper build on top of RDKit.
* [Indigo](https://github.com/epam/Indigo) ⭐ 406 | 🐛 752 | 🌐 C++ | 📅 2026-09-16 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [pdb-tools](https://github.com/haddocking/pdb-tools) ⭐ 456 | 🐛 4 | 🌐 Python | 📅 2026-06-10 - A swiss army knife for manipulating and editing PDB files.
* [ChEMBL\_Structure\_Pipeline (formerly standardiser)](https://github.com/chembl/ChEMBL_Structure_Pipeline) ⭐ 248 | 🐛 9 | 🌐 Python | 📅 2025-11-24 - Tool designed to provide a simple way of standardising molecules as a prelude to e.g. molecular modelling exercises.
...
* [3Dmol.js](https://github.com/3dmol/3Dmol.js) ⭐ 1,018 | 🐛 44 | 🌐 Jupyter Notebook | 📅 2026-09-12 - An object-oriented, webGL based JavaScript library for online molecular visualization.
* [rdeditor](https://github.com/EBjerrum/rdeditor) ⭐ 179 | 🐛 4 | 🌐 Python | 📅 2026-05-03 - Simple RDKit molecule editor GUI using PySide.
* [JChemPaint](https://github.com/JChemPaint/jchempaint) ⭐ 146 | 🐛 115 | 🌐 Java | 📅 2026-04-24 - Chemical 2D structure editor application/applet based on the [Chemistry Development Kit](https://sourceforge.net/projects/cdk/).
...
* [DescriptaStorus](https://github.com/bp-kelley/descriptastorus) ⭐ 281 | 🐛 3 | 🌐 Python | 📅 2024-10-26 - Descriptor computation(chemistry) and (optional) storage for machine learning.
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,999 | 🐛 1,182 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,465 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Directed message passing neural networks for property prediction of molecules and reactions with uncertainty and interpretation.
* [DGL-LifeSci](https://github.com/awslabs/dgl-lifesci) ⭐ 810 | 🐛 32 | 🌐 Python | 📅 2023-11-01 - DGL-LifeSci is a [DGL](https://www.dgl.ai/)-based package for various applications in life science with graph neural network.
...
* [ChemML](https://github.com/hachmannlab/chemml) ⭐ 180 | 🐛 3 | 🌐 Python | 📅 2026-09-11 - ChemML is a machine learning and informatics program suite for the analysis, mining, and modeling of chemical and materials data. (based on Tensorflow)
...
* [webchem](https://github.com/ropensci/webchem) ⭐ 185 | 🐛 61 | 🌐 R | 📅 2026-08-30 - Chemical Information from the Web.
...
* [DOCKSTRING](https://github.com/dockstring/dockstring) ⭐ 190 | 🐛 8 | 🌐 Python | 📅 2026-05-24 - Automates and standardizes ligand preparation for AutoDock Vina.
...
* [MDTraj](https://github.com/mdtraj/mdtraj) ⭐ 733 | 🐛 87 | 🌐 Python | 📅 2026-09-15 - Analysis of molecular dynamics trajectories.
* [ProDy](https://github.com/prody/ProDy) ⭐ 557 | 🐛 37 | 🌐 Python | 📅 2026-09-15 - A Python package for protein dynamics analysis
* [cclib](https://github.com/cclib/cclib) ⭐ 427 | 🐛 194 | 🌐 Python | 📅 2026-09-15 - Parsers and algorithms for computational chemistry logfiles.
...
* [Cookiecutter for Computational Molecular Sciences](https://github.com/MolSSI/cookiecutter-cms) ⭐ 463 | 🐛 30 | 🌐 Python | 📅 2025-12-15 - Python-centric Cookiecutter for Molecular Computational Chemistry Packages by [MolSSL](https://molssi.org/)
...
* [TeachOpenCADD](https://github.com/volkamerlab/TeachOpenCADD) ⭐ 1,071 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A teaching platform for computer-aided drug design (CADD) using open source packages and data.
...
* [deeplearning-biology](https://github.com/hussius/deeplearning-biology#chemoinformatics-and-drug-discovery-) ⭐ 2,156 | 🐛 0 | 📅 2026-09-12 - Chemoinformatics and drug discovery section in deeplearning-biology repo.
* [awesome-python-chemistry](https://github.com/lmmentel/awesome-python-chemistry) ⭐ 1,440 | 🐛 10 | 📅 2025-09-21 - Another list focuses on Python stuff related to Chemistry.
