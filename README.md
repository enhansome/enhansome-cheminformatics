...
* [Indigo](https://github.com/epam/Indigo) ⭐ 406 | 🐛 755 | 🌐 C++ | 📅 2026-09-18 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [ChEMBL\_Structure\_Pipeline (formerly standardiser)](https://github.com/chembl/ChEMBL_Structure_Pipeline) ⭐ 249 | 🐛 9 | 🌐 Python | 📅 2025-11-24 - Tool designed to provide a simple way of standardising molecules as a prelude to e.g. molecular modelling exercises.
* [MolVS](https://github.com/mcs07/MolVS) ⭐ 187 | 🐛 23 | 🌐 Python | 📅 2020-04-16 - Molecule validation and standardization based on [RDKit](http://www.rdkit.org/).
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 7,003 | 🐛 1,180 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,466 | 🐛 20 | 🌐 Python | 📅 2026-09-01 - Directed message passing neural networks for property prediction of molecules and reactions with uncertainty and interpretation.
...
* [MDTraj](https://github.com/mdtraj/mdtraj) ⭐ 735 | 🐛 89 | 🌐 Python | 📅 2026-09-16 - Analysis of molecular dynamics trajectories.
* [ProDy](https://github.com/prody/ProDy) ⭐ 557 | 🐛 37 | 🌐 Python | 📅 2026-09-15 - A Python package for protein dynamics analysis
* [cclib](https://github.com/cclib/cclib) ⭐ 427 | 🐛 194 | 🌐 Python | 📅 2026-09-17 - Parsers and algorithms for computational chemistry logfiles.
...
* [OPSIN](https://github.com/dan2097/opsin) ⭐ 237 | 🐛 110 | 🌐 Java | 📅 2026-08-19 - Open Parser for Systematic IUPAC nomenclature
...
* [TeachOpenCADD](https://github.com/volkamerlab/TeachOpenCADD) ⭐ 1,069 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A teaching platform for computer-aided drug design (CADD) using open source packages and data.
...
* [awesome-python-chemistry](https://github.com/lmmentel/awesome-python-chemistry) ⭐ 1,441 | 🐛 10 | 📅 2025-09-21 - Another list focuses on Python stuff related to Chemistry.
