...
* [datamol](https://github.com/datamol-org/datamol) ⭐ 549 | 🐛 3 | 🌐 Python | 📅 2026-09-09: - Molecular Manipulation Made Easy. A light wrapper build on top of RDKit.
* [Indigo](https://github.com/epam/Indigo) ⭐ 406 | 🐛 751 | 🌐 C++ | 📅 2026-09-09 - Universal molecular toolkit that can be used for molecular fingerprinting, substructure search, and molecular visualization written in C++ package, with Java, C#, and Python wrappers.
...
* [3Dmol.js](https://github.com/3dmol/3Dmol.js) ⭐ 1,016 | 🐛 44 | 🌐 Jupyter Notebook | 📅 2026-09-01 - An object-oriented, webGL based JavaScript library for online molecular visualization.
...
* [mordred](https://github.com/mordred-descriptor/mordred) ⭐ 480 | 🐛 55 | 🌐 Python | 📅 2024-02-07 - Molecular descriptor calculator based on [RDKit](http://www.rdkit.org/).
...
* [DeepChem](https://github.com/deepchem/deepchem) ⭐ 6,983 | 🐛 1,174 | 🌐 Python | 📅 2026-08-20 - Deep learning library for Chemistry based on Tensorflow
* [Chemprop](https://github.com/chemprop/chemprop) ⭐ 2,462 | 🐛 21 | 🌐 Python | 📅 2026-09-01 - Directed message passing neural networks for property prediction of molecules and reactions with uncertainty and interpretation.
...
* [ChemML](https://github.com/hachmannlab/chemml) ⭐ 180 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - ChemML is a machine learning and informatics program suite for the analysis, mining, and modeling of chemical and materials data. (based on Tensorflow)
...
* [MDTraj](https://github.com/mdtraj/mdtraj) ⭐ 732 | 🐛 88 | 🌐 Python | 📅 2026-09-07 - Analysis of molecular dynamics trajectories.
* [ProDy](https://github.com/prody/ProDy) ⭐ 555 | 🐛 37 | 🌐 Python | 📅 2026-09-09 - A Python package for protein dynamics analysis
* [cclib](https://github.com/cclib/cclib) ⭐ 425 | 🐛 194 | 🌐 Python | 📅 2026-09-09 - Parsers and algorithms for computational chemistry logfiles.
...
* [TeachOpenCADD](https://github.com/volkamerlab/TeachOpenCADD) ⭐ 1,064 | 🐛 59 | 🌐 Jupyter Notebook | 📅 2026-09-01 - A teaching platform for computer-aided drug design (CADD) using open source packages and data.
...
* [awesome-python-chemistry](https://github.com/lmmentel/awesome-python-chemistry) ⭐ 1,439 | 🐛 10 | 📅 2025-09-21 - Another list focuses on Python stuff related to Chemistry.
